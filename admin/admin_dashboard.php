            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center pt-5">
                        <h3 style="font-weight: 800;color:#ff5b00;" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" data-aos-once="true">Products <?php echo $_SESSION['name']; ?></h3>
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <td class="td-questionlist">
                                                                            <div>
                                                                                ...
                                                                                <!-- <input type="checkbox" value="<img src='assets/upload/<?php echo  $file  = $row['images']; ?>'" name="name[]"> -->
                                                                            </div>
                                                                        </td>
                                                                        <td class="td-questionlist">
                                                                            <div>
                                                                        ...
                                                                        <td class="td-questionlist">
                                                                            <div>
                                                                                <img src="assets/products/<?php echo  $row['images']; ?>" id="images" name="images[]" style="width:50px;height:auto;">
                                                                        ...
                                                                        <td class="td-questionlist">
                                                                            <span> 
                                                                                ...
                                                                                <!-- <input type="checkbox" value="<?php echo $row['description']; ?>" name="name[]"> -->
                                                                            </span>
                                                                        </td>
                                                                        <td class="td-questionlist">
                                                                            <span> 
                                                                                <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger text-white font-weight-bold" onclick="return confirm('Are you sure you want to delete this item?');">Item Delete</a>
                                                                            </span>
                                                                        </td>
                                                                        <td class="td-questionlist">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                ...
                                                                                                <div class="col-md-8">
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <input type="hidden" value="<?php echo $row['id']?>" name="id"/>
                                                                                                        <input type="text" class="form-control" value="<?php echo $row['category']?>" name="category" required="required"/>
                                                                                                    </div>
                                                                                                    <div class="form-group">
